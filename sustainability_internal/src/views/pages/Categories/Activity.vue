  ...
  <PageBase>
    <div id="choose-categories" class="module-page-container">
      <E
        ...
        :h="json.e_prompt"
        t="h3"
        class="small-text italic-prompt the-activity-prompt"
      />
        ...
        <div class="selector-side">
          ...
          <div id="feedback-container">
            <div id="attempt-counter">
              <E t="span" :h="json.e_attempt_prompt" class="attempt-text" />
              <span class="attempt-text">{{ attempt }} of 3</span>
            </div>
            <transition
            ...
            >
              ...
              >
                ...
                <transition
                  ...
                  :leave-active-class="`${TExit.FADE_OUT} ${TTimes.VERY_FAST}`"
                >
                  <div @click="goToNext" id="continue-container">
                    <div class="button continue-button small-button">
                      <strong>Continue</strong>
                    </div>
                  </div>
...
export default Vue.extend({
  ...
  methods: {
    ...
    finishOrReset() {
      ...
      // else if (this.outOfAttemptsReveal) {
      //   // this.proceedToFinalMessage()
      //   console.log("THIS IS THE OUT OF ATTEMPTS REVEAL")
      //   this.outOfAttemptsReveal = true
      // }
    },
    goToNext() {
      // okey dokie
      // send the correct ids to the store
      // this.$store.commit

      this.$store.commit("meta/setLesson3ChosenIds", [
        this.selectedIdOne,
        this.selectedIdTwo,
